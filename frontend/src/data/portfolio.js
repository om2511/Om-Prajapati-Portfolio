export const navItems = [
  ...
  { id: "projects", label: "Projects", icon: "ri-briefcase-4-line" },
  { id: "services", label: "Services", icon: "ri-service-line" },
  { id: "approach", label: "Approach", icon: "ri-compass-3-line" },
  { id: "resume", label: "Resume", icon: "ri-file-list-3-line" },
  { id: "contact", label: "Contact", icon: "ri-chat-1-line" }
];
...
export const stackGroups = [
  ...
  {
    title: "Workflow",
    items: ["Git", "GitHub", "Render", "Vite", "Component Architecture"]
  }
];

export const projects = [
  {
    title: "PlantCare AI: Intelligent Gardening Companion",
    category: "AI Gardening Assistant",
    description:
      "Transform your gardening experience with AI-powered insights, personalized care schedules, instant disease detection, and expert recommendations tailored for Indian climate and plants.",
    image: "/PlantCare%20AI.png",
    githubUrl: "https://github.com/om2511/PlantCare-AI",
    liveUrl: "https://plant-care-ai-nine.vercel.app/",
    highlights: ["AI insights", "Disease detection", "Indian climate guidance"]
  },
  {
    title: "RecipeWala",
...
export const socialLinks = [
  ...
  },
  {
    ...
    value: "@OmPrajapati25",
    href: "https://x.com/OmPrajapati25"
  },
  {
    label: "Instagram",
    icon: "ri-instagram-fill",
    value: "om_prajapati_2511",
    href: "https://www.instagram.com/om_prajapati_2511/"
  }
];

export const youtubeLinks = [
  {
    label: "CodeCraftedWeb",
    icon: "ri-youtube-fill",
    href: "https://www.youtube.com/@CodeCraftedWeb"
  },
  {
    label: "Om Prajapati",
    icon: "ri-youtube-fill",
    href: "https://www.youtube.com/@om.prajapati.25"
  }
];
